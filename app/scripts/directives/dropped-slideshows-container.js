(function () {
    ...
    function DirectiveController($rootScope) {
        ...
        /**
        * Toggles visibility of the given slideshow edit toolbar. If the toolbar
        ...
        */
        ...
        /**
        * Stops tracking the given slideshow edit toolbar. Must be invoked when
        * the corresponding dropped slideshow is removed from the editor content.
        *
    ...
    /**
    * A directive which makes an HTML element aware of the dropped slideshows
    * beneath it in the DOM tree.
    *
    * @class droppedSlideshowsContainer
    */
    angular.module('authoringEnvironmentApp')
    .directive('droppedSlideshowsContainer', function () {
        return {
            restrict: 'A',
